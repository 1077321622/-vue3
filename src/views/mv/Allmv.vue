 ...
 * @LastEditTime: 2022-12-28 10:15:52
  ...
  <el-form :inline="true" :model="formInline" class="demo-form-inline">
    ...
    <el-form-item label="分类">
      <el-select v-model="formInline.region" placeholder="请选择分类">
            ...
            <el-option label="内地" value="内地" />
            <el-option label="港台" value="港台" />
...
<script  setup>
import { wyy_AllMv, wyy_SingerMvPlay } from "../../api/index.js";
